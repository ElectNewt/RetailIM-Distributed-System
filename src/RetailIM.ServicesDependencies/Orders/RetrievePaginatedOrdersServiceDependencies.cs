...
{
    public class RetrievePaginatedOrdersServiceDependencies : IRetrievePaginatedOrdersDependencies
    {
        ...
        public RetrievePaginatedOrdersServiceDependencies(IOrderRepository orderRepo, IDeliveryRepository deliveryRepo, IOrderProductsRepository orderProductRepo,
        ...
        public async Task<ReadOnlyCollection<OrderEntity>> GetOrders(int page, int itemsPerPage)
            => await _orderRepo.GetPaginated(page, itemsPerPage);
